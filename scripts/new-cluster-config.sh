...
echo ""
echo -e "3. Provision cluster:"
echo -e "   ${BLUE}cd tofu/clusters/$CLUSTER_NAME${NC}"
echo -e "   ${BLUE}tofu init${NC}"
echo -e "   ${BLUE}tofu plan${NC}"
echo -e "   ${BLUE}tofu apply${NC}"
echo ""
echo -e "4. Get kubeconfig:"
echo -e "   ${BLUE}tofu output -raw kubeconfig > ~/.kube/$CLUSTER_NAME${NC}"
echo -e "   ${BLUE}export KUBECONFIG=~/.kube/$CLUSTER_NAME${NC}"
echo ""
echo -e "5. Create client configuration:"
echo -e "   ${BLUE}./scripts/new-client-config.sh myclient myclient.com${NC}"
echo ""
echo -e "6. Bootstrap applications (one command!):"
